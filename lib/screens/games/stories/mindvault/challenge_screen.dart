...
class MindVaultChallengeScreen extends StatefulWidget {
  final String prompt;
  final String title;
  final int chapterIndex;
  final VoidCallback onNext;
  final bool isFinal;
  const MindVaultChallengeScreen({
    super.key,
  ...
  @override
  State<MindVaultChallengeScreen> createState() => _MindVaultChallengeScreenState();
}

class _MindVaultChallengeScreenState extends State<MindVaultChallengeScreen> {
  ...
  static const expectedOutputs = [
    'detpyrcne', // Chapter 1: reversed string for demo
    '[1, 2, 3]', // Chapter 2: sorted unique list for demo
  ];
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.memory, color: Color(0xFF00FFFF), size: 60),
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        fontSize: 24,
                        fontFamily: 'FiraMono',
                        shadows: [Shadow(color: Color(0xFF00FFFF), blurRadius: 18)],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        maxLines: 10,
                        minLines: 6,
                        style: const TextStyle(color: Color(0xFF00FFFF), fontFamily: 'FiraMono', fontSize: 16),
                    ...
                    if (_ran && _feedback != null) ...[
                      ...
                      Text(
                        _feedback!,
                        style: TextStyle(
                          color: _isCorrect ? Colors.cyanAccent : Colors.redAccent,
                          fontFamily: 'FiraMono',
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
                          shadows: [
                            Shadow(color: _isCorrect ? Colors.cyan : Colors.red, blurRadius: 8),
                          ],
                        ),
                      ),
                    ],
