...
class CompilerProphecyChallengeScreen extends StatefulWidget {
  final String prompt;
  final String title;
  final int chapterIndex;
  final VoidCallback onNext;
  final bool isFinal;
  const CompilerProphecyChallengeScreen({
    super.key,
  ...
  @override
  State<CompilerProphecyChallengeScreen> createState() => _CompilerProphecyChallengeScreenState();
}

class _CompilerProphecyChallengeScreenState extends State<CompilerProphecyChallengeScreen> {
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.code, color: Color(0xFF00FF00), size: 60),
                    ...
                    if (_ran && _feedback != null) ...[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 16,
                          shadows: [
                            Shadow(color: _isCorrect ? Colors.green : Colors.red, blurRadius: 8),
                          ],
                        ),
                      ),
                    ],
